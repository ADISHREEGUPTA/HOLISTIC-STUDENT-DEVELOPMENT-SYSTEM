...
label = Label(root, text="TEACHER LOGIN", font=('Arial', 20),bg="grey",fg='white')
...
regbutton = Button(frame,text="Register As Teacher ?", bd=0, cursor='hand2', bg='gold', activebackground='gold',

...
conn=connect.cursor()
conn.execute("select r.name as NAME,r.age as AGE,r.class as CLASS,k.credits as CREDITS from class_12_details r, student_12_credits k where r.name=k.name group by class order by credits")
...
def save():
    import csv
    f=open("F:\\HSDS_ADISHREE_CLASS_12\\student_12.csv","w")

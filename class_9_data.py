...
conn=connect.cursor()
conn.execute("select r.name as NAME,r.age as AGE,r.class as CLASS,k.credits as CREDITS from class_9_details r, student_9_credits k where r.name=k.name group by class order by credits")
